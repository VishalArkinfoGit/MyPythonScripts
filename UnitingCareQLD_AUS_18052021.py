...
my_path = "Documents\\UnitingCareQLD_AUS_18052021.xlsx"
...
for i in range(1, 445 + 1):
    URL = 'https://www.unitingcareqld.com.au/locate/services?lat='+str(postcode_sheet_obj.cell(row = i, column = 4).value)+'&lng='+str(postcode_sheet_obj.cell(row = i, column = 5).value)
    print(URL)
...
for z in range(len(listOBJ)):
    ...
    wb_obj_w.save("Documents\\UnitingCareQLD_AUS_18052021.xlsx")
